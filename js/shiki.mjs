...
// INSTALLATION
document.getElementById('installCDN').innerHTML = await codeToHtml('<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/fordus/shadcn-classless@main/dist/shadcn-classless.css">', {lang,theme})
